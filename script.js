...
function loadVIPPlans() {
  db.ref('plans').on('value', snap => {
    ...
    const defaultPlans = [
      { id: 'p1', name: 'MICRO ONLINE', price: 500, dailyTasks: 2, dailyProfit: 15, durationDays: 30, vipLevel: 1, badgeText: '', isSoldOut: false },
      { id: 'p2', name: 'SUPER VIP', price: 1500, dailyTasks: 5, dailyProfit: 50, durationDays: 30, vipLevel: 2, badgeText: 'POPULAR', isSoldOut: false },
      { id: 'p3', name: 'PRO EARNER', price: 3000, dailyTasks: 10, dailyProfit: 110, durationDays: 30, vipLevel: 3, badgeText: 'HOT DEAL', isSoldOut: false }
    ];
...
function renderLiveWithdrawsInfinite() {
  ...
  const mockFeed = [
    ...
    { num: '016****8016', method: 'bKash', amount: '৳১৫০০' },
    { num: '019****9366', method: 'bKash', amount: '৳৩০০০' },
    { num: '017****7267', method: 'bKash', amount: '৳১০৫০০' },
    { num: '016****9610', method: 'bKash', amount: '৳১০০০০' },
    { num: '013****8772', method: 'bKash', amount: '৳১৬০০' },
    { num: '014****4651', method: 'bKash', amount: '৳১৮৫০০' },
    { num: '017****8047', method: 'bKash', amount: '৳২০০০০' },
    { num: '019****6375', method: 'bKash', amount: '৳৮০০০' },
    { num: '014****1748', method: 'bKash', amount: '৳৮০০' },
    { num: '018****0262', method: 'bKash', amount: '৳১৮০০' },
    { num: '016****9174', method: 'bKash', amount: '৳২৬০০' },
  ];
